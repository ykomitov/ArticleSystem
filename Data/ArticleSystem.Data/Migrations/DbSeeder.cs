namespace ArticleSystem.Data.Migrations
{
    ...
    public static class DbSeeder
    {
        ...
        {
            const string SliderImageArticle1 = "1-s.jpg";
            const string HeaderImageArticle1 = "1-a.jpg";
            const string IndexImageArticle1 = "1-h.jpg";

            const string HeaderImageArticle2 = "2-a.jpg";
            const string SliderImageArticle2 = "2-s.jpg";
            const string IndexImageArticle2 = "2-h.jpg";

            const string SliderImageArticle3 = "3-s.jpg";
            const string HeaderImageArticle3 = "3-a.jpg";
            const string IndexImageArticle3 = "3-h.jpg";

            const string SliderImageArticle4 = "4-s.jpg";
            const string HeaderImageArticle4 = "4-a.jpg";
            const string IndexImageArticle4 = "4-h.jpg";

            const string SliderImageArticle5 = "5-s.jpg";
            const string HeaderImageArticle5 = "5-a.jpg";
            const string IndexImageArticle5 = "5-h.jpg";

            const string SliderImageArticle6 = "6-s.jpg";
            const string HeaderImageArticle6 = "6-a.jpg";
            const string IndexImageArticle6 = "6-h.jpg";

            const string SliderImageArticle7 = "7-s.jpg";
            const string HeaderImageArticle7 = "7-a.jpg";
            const string IndexImageArticle7 = "7-h.jpg";

            const string SliderImageArticle8 = "8-s.jpg";
            const string HeaderImageArticle8 = "8-a.jpg";
            const string IndexImageArticle8 = "8-h.jpg";

            const string SliderImageArticle9 = "9-s.jpg";
            const string HeaderImageArticle9 = "9-a.jpg";
            const string IndexImageArticle9 = "9-h.jpg";

            const string SliderImageArticle10 = "10-s.jpg";
            const string HeaderImageArticle10 = "10-a.jpg";
            const string IndexImageArticle10 = "10-h.jpg";

            const string SliderImageArticle11 = "11-s.jpg";
            const string HeaderImageArticle11 = "11-a.jpg";
            const string IndexImageArticle11 = "11-h.jpg";

            const string SliderImageArticle12 = "12-s.jpg";
            const string HeaderImageArticle12 = "12-a.jpg";
            const string IndexImageArticle12 = "12-h.jpg";
            ...
            if (!context.Articles.Any())
            {
                ...
                var sampleArticle1 = new Article()
                {
                    ...
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle1),
                    IndexImageFileName = IndexImageArticle1,
                ...
                var sampleArticle2 = new Article()
                {
                    ...
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle2),
                    IndexImageFileName = IndexImageArticle2,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle3 = new Article()
                {
                    ...
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle3),
                    HeaderImageFileName = HeaderImageArticle3,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle3),
                    IndexImageFileName = IndexImageArticle3,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                {
                    Title = "WFP uses innovative iris scan technology to provide food assistance to syrian refugees",
                    ...
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle4),
                    HeaderImageFileName = HeaderImageArticle4,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle4),
                    IndexImageFileName = IndexImageArticle4,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle5 = new Article()
                {
                    ...
                    Category = context.ArticleCategories.Where(c => c.Id == 2).FirstOrDefault(),
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle5),
                    SliderImageFileName = SliderImageArticle5,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle5),
                    HeaderImageFileName = HeaderImageArticle5,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle5),
                    IndexImageFileName = IndexImageArticle5,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle6 = new Article()
                {
                    ...
                    Category = context.ArticleCategories.Where(c => c.Id == 2).FirstOrDefault(),
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle6),
                    SliderImageFileName = SliderImageArticle6,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle6),
                    HeaderImageFileName = HeaderImageArticle6,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle6),
                    IndexImageFileName = IndexImageArticle6,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle7 = new Article()
                {
                    ...
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle7),
                    SliderImageFileName = SliderImageArticle7,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle7),
                    HeaderImageFileName = HeaderImageArticle7,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle7),
                    IndexImageFileName = IndexImageArticle7,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle8 = new Article()
                {
                    ...
                    Category = context.ArticleCategories.Where(c => c.Id == 3).FirstOrDefault(),
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle8),
                    SliderImageFileName = SliderImageArticle8,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle8),
                    HeaderImageFileName = HeaderImageArticle8,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle8),
                    IndexImageFileName = IndexImageArticle8,
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle9 = new Article()
                {
                    ...
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle9),
                    SliderImageFileName = SliderImageArticle9,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle9),
                    HeaderImageFileName = HeaderImageArticle9,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle9),
                    IndexImageFileName = IndexImageArticle9,
                ...
                var sampleArticle10 = new Article()
                {
                    ...
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle10),
                    SliderImageFileName = SliderImageArticle10,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle10),
                    HeaderImageFileName = HeaderImageArticle10,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle10),
                    IndexImageFileName = IndexImageArticle10,
                    Category = context.ArticleCategories.Where(c => c.Id == 4).FirstOrDefault(),
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
                ...
                var sampleArticle11 = new Article()
                {
                    ...
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle11),
                    SliderImageFileName = SliderImageArticle11,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle11),
                    HeaderImageFileName = HeaderImageArticle11,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle11),
                    IndexImageFileName = IndexImageArticle11,
                ...
                var sampleArticle12 = new Article()
                {
                    ...
                    SliderImage = imageConverter.ConvertImageToByteArray(pathBase + SliderImageArticle12),
                    SliderImageFileName = SliderImageArticle12,
                    HeaderImage = imageConverter.ConvertImageToByteArray(pathBase + HeaderImageArticle12),
                    HeaderImageFileName = HeaderImageArticle12,
                    IndexImage = imageConverter.ConvertImageToByteArray(pathBase + IndexImageArticle12),
                    IndexImageFileName = IndexImageArticle12,
                    Category = context.ArticleCategories.Where(c => c.Id == 5).FirstOrDefault(),
                    Author = context.Users.OrderBy(u => Guid.NewGuid()).FirstOrDefault()
                };
